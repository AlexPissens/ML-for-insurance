...
# Build the Neural Network (Wider with Dropout)
model = keras.Sequential([
    layers.Dense(128, activation="relu", input_shape=(X_train.shape[1],)),  # Hidden layer with 128 units
    layers.Dropout(0.3),                                                    # Dropout 30% of neurons to prevent overfitting
